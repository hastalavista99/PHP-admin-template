        ...
        <div class="row bg-white border-radius-lg shadow-primary me-2 ms-2 my-3">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h5 class="text-white text-capitalize ps-3">Rent Payment</h5>
              </div>
            </div>
                <form class="row g-3 my-1">
                <div class="col-md-4">
                    <label for="unitLease" class="form-label">Unit Lease</label>
                    <select id="unitLease" class="form-select ps-2">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control ps-2" id="amountPaid" value="0">
                </div>
                <div class="col-md-3">
                    <label for="payDate" class="form-label">Payment Date</label>
                    <input type="date" class="form-control ps-2" id="payDate">
                </div>

                <div class="col-md-3">
                    <label for="payMedium" class="form-label">Paid Through</label>
                    <select id="payMedium" class="form-select ps-2">
                    <option selected>Choose...</option>
                    <option value=""></option>
                    <option value=""></option>
                    </select>
                ...
                <div class="col-md-4">
                    <label for="payNum" class="form-label">Payment Reference Number</label>
                    <input type="text" class="form-control ps-2" id="payNum" value="0">
                </div>
                <div class="col-md-4">
                    <label for="rentPay" class="form-label">Payment Accepted By</label>
                    <select id="rentPay" class="form-select ps-2">
                    <option selected>Choose...</option>
                    <option value=""></option>
                    <option value=""></option>
                    </select>
