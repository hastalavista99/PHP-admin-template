...
<div class="container">
  ...
  echo '<form class="row g-3 my-1" action="billscon.php?bill_id=' . $bill_id . '" method="post">
        ...
        <div class="col-md-3">
          ...
          <input type="number" class="form-control ps-2" id="commission" name="commission" placeholder="$" autocomplete="off">
        </div>
        <div class="col-md-3">
          <label for="rent" class="form-label">Rent *</label>
          <input type="number" class="form-control ps-2" id="rent" name="rent" placeholder="$" autocomplete="off">
        </div>
        <div class="col-md-3">
          <label for="deposit" class="form-label">Deposit</label>
          <input type="number" class="form-control ps-2" id="deposit" name="deposit" placeholder="$"  autocomplete="off">
        </div>
        <div class="col-md-3">
          <label for="service" class="form-label">Service Charge</label>
          <input type="number" class="form-control ps-2" id="service" name="service" placeholder="$" autocomplete="off">
        </div>
        <div class="col-md-3">
          <label for="water" class="form-label">Water Deposit</label>
          <input type="number" class="form-control ps-2" id="water" name="water" placeholder="$" autocomplete="off">
        </div>
        <div class="col-md-3">
          <label for="electricity" class="form-label">Electricity Deposit</label>
          <input type="number" class="form-control ps-2" id="electricity" name="electricity" placeholder="$" autocomplete="off">
        </div>
        <div class="col-9">
  ...
  <div class="table-responsive p-0">
    ...
    echo '<div class="d-flex justify-content-end me-3">
          <div class="total h4">Total: <span class="text-xs">KES</span> ' . $format_total . ' </div>
        </div>';
    ?>
  </div>
