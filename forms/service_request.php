  ...
  <aside class="sidenav sidebar close navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <a class="nav-link btn-toggle collapsed active" data-bs-toggle="collapse" data-bs-target="#tenants-collapse" aria-expanded="true">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">groups</i>
          </div>
          <span class="nav-link-text ms-1">Tenants</span>
        </a>
        <div class="collapse" id="tenants-collapse">
          <ul class="btn-toggle-nav list-unstyled">
            <li><a href="tenants.php" class="light-link text-white drop ms-6">Register Tenant</a></li>
            <li><a href="../tables/tenants_view.php" class="light-link text-white drop ms-6">View Tenants</a></li>
          </ul>
        </div>
        ...
        <div class="row bg-white border-radius-lg shadow-primary me-2 ms-2 my-3">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h5 class="text-white text-capitalize ps-3">Service Request</h5>
              </div>
            </div>
                <form class="row g-3 my-1">
                <div class="col-md-4">
                    <label for="inputState" class="form-label">Unit Lease</label>
                ...
                <div class="col-md-4">
                    <label for="inputState" class="form-label">Service Category</label>
                    <select id="inputState" class="form-select ps-2">
                    <option selected>Choose...</option>
                    <option value=""></option>
                    <option value=""></option>
                ...
                <div class="col-md-6">
                    ...
                    <textarea type="text" class="form-control ps-2" id="problemDescription"></textarea>
                </div>
                <div class="col-md-4">
                    <label for="logDate" class="form-label">Date</label>
                    <input type="date" class="form-control ps-2" id="logDate">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <label for="closureDate" class="form-label">Closure</label>
                    <input type="date" class="form-control ps-2" id="closureDate">
                </div>
