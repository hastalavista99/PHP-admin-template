        ...
        <div class="row bg-white border-radius-lg shadow-primary me-2 ms-2 my-3">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h5 class="text-white text-capitalize ps-3">Staff Details</h5>
              </div>
            </div>
                ...
                <div class="col-md-3">
                    <label for="inputState" class="form-label">Staff Role</label>
                ...
                <div class="col-md-6">
                    <label for="employmentStart" class="form-label">Employment Start Date</label>
                    <input type="date" class="form-control ps-2" id="employmentStart">
                </div>
                <div class="col-md-6">
                    <label for="employmentEnd" class="form-label">Employment End Date</label>
                    <input type="date" class="form-control ps-2" id="employmentEnd">
                </div>
                <div class="col-12">
