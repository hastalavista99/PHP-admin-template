  ...
  <aside class="sidenav sidebar close navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-2">
        <a class="nav-link btn-toggle collapsed active" data-bs-toggle="collapse" data-bs-target="#properties-collapse" aria-expanded="true">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <div class="col-md-12">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                  <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <h5 class="text-white text-capitalize ps-3">Add Property Units</h5>
                  </div>
                </div>
                    <form class="row g-3 my-1">
                      <div class="col-md-6">
                          <label for="mainProperty" class="form-label">Select Main Property *</label>
                          <select id="mainProperty" class="form-select ps-2" required>
                          <option selected>Property Test Here</option>
                          <option value=""></option>
                          <option value=""></option>
                          </select>
                      </div>
                      <div class="col-md-6">
                          <label for="unitTitle" class="form-label">Property Unit Title *</label>
                          <input type="text" class="form-control ps-2" id="unitTitle" required>
                      </div>
                      <div class="col-md-4">
                          <label for="commission" class="form-label">Commission *</label>
                          <input type="text" class="form-control ps-2" id="commission" placeholder="0" required>
                      </div>
                      <div class="col-md-4">
                          <label for="rent" class="form-label">Rent *</label>
                          <input type="text" class="form-control ps-2" id="rent" required>
                      </div>
                      <div class="col-md-4">
                          <label for="deposit" class="form-label">Deposit</label>
                          <input type="text" class="form-control ps-2" id="deposit" required>
                      </div>
                      <div class="col-md-3">
                          <label for="bedroomNum" class="form-label">No of Bedrooms</label>
                          <input type="number" class="form-control ps-2" id="bedroomNum" value="0">
                      </div>
                      <div class="col-md-3">
                          <label for="bathroomNum" class="form-label">No of Bathrooms</label>
                          <input type="number" class="form-control ps-2" id="bathroomNum" value="0">
                      </div>
                      <div class="col-md-3">
                          <label for="balconiesNum" class="form-label">No of Balconies</label>
                          <input type="number" class="form-control ps-2" id="balconiesNum" value="0">
                      </div>
                      ...
                      <div class="col-md-6">
                          <label for="inputState" class="form-label">Availability From</label>
                          <input type="date" class="form-control ps-2" id="inputState">
                      </div>
                      <div class="col-12">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="gridCheck">
                      ...
                      <div class="col-md-6">
                          ...
                          <textarea type="text" class="form-control ps-2" id="description"></textarea>
                      </div>
                      <div class="col-12">
