          ...
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="table-responsive p-0">
                <table class="table table-striped table-hover align-items-center mb-0" id="propertyView">
                  <thead>
                    <tr>
        ...
        <div class="modal-body">
          ...
          <input type="hidden" id="propertyId" name="propertyId" value="">
            ...
            <div class="col-md-4">
              ...
              <select id="type" name="typeSelect" class="form-select ps-2">
            ...
            <div class="col-md-4 mt-5">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" id="gridCheck" name="propertyStatus" value="active">
          ...
          <div class="col-md-6">
              ...
              <input type="text" class="form-control ps-2" id="inputAddress2" name="address" placeholder="Apartment, studio, or floor" autocomplete="off">
          </div> -->

            <div class="col-12">
              <button type="submit" name="property" class="btn btn-primary">Create</button>
            </div>
          </form>
