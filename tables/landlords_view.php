  ...
  <div class="row">
    <div class="col-12">
      <div class="card my-4">
        ...
        <div id="landlordViewTable" class="table-responsive p-0">
      ...
      <div class="modal-body">
        ...
        <div class="form-group col-md-5">
          ...
          <div class="col-12 my-3">
            <button type="button" name="landlord" class="btn btn-primary" onclick="addLandlord()">Create</button>
          </div>
...
<script>
  ...
  const landlordModal = new bootstrap.Modal('#landlordModal');
  ...
  function displayData() {
    ...
    $.ajax({
      ...
      type: 'post',
      data: {
        displayLandlord: displayData
      },
      success: function(data, status) {
        $('#landlordViewTable').html(data);
      }
    })
  }
