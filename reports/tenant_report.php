            ...
            <div class="card my-4">
                <div class="d-flex justify-content-between">
                    <div class="row card-header col-md-7 p-0 mx-3 z-index-2 mt-3" style="height: 25px;">
                        <div class="pt-1 pb-1">
                            <h4 class="row text-capitalize ps-3">Tenant Report <span class="fst-italic text-xs">(assigned)</span></h4>
                        </div>
                    </div>
                    <div class="col-md-2 pt-3">
                        <div>
                            <a class="btn btn-primary" href="reports_view.php">
                                back
                            </a>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-hover align-items-center mb-0" id="tenantReport">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT
                                    ...
                                    units_two.unit_number,
                                    landlords.name AS landlord_name,
                                    tenants_two.contract
                                FROM
                                    tenants_two
                                LEFT JOIN
                                    units_two ON units_two.id = tenants_two.unit_id
                                LEFT JOIN
                                    properties ON properties.id = tenants_two.property_id
                                LEFT JOIN
